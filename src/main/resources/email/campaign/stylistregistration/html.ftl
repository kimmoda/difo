                ...
                <tr>
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:14px;line-height:20px;color:#484848;font-family:Arial, Helvetica, sans-serif;">
                            <p>
                                Thank you for applying to become a verified influencer on ${data.brandName}.
                            </p>
                            ...
                            <p>In the meantime, if you have any questions, please do not hesitate to reach out to our friendly support team at <a
                                    href="${data.supportEmail}" style="color: #484848"> ${data.supportEmail}</a> or visit our <a href="${data.homeUrl}/faq">FAQs section</a>.</p>
                            <p>
                                Thank you,
                            </p>
                            <p>
