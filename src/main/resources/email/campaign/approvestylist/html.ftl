                    ...
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:14px;line-height:20px;color:#484848;font-family:Arial, Helvetica, sans-serif;">
                            <p>
                                ...
                                an excellent ${data.brandName} Influencer! We are delighted to have you join our community!
                            </p>
                            <p>
                               You will be able to:
                            </p>
                            <ol>
                                <li>
                                    Help other influencers' campaigns and earn WHB coins. WHB coins are our own digital currency. You can accumulate coins to promote your social media posts or exchange them for products or services!
                                </li>
                                <li>
                                    Publish your own campaigns to get promoted by other influencers, get found online and boost exposure and brand engagement.
                                </li>
                            </ol>
                            ...
                            <p>If you have any questions, please do not hesitate to reach out to our friendly support
                                team at <a
                                    ...
                                    ${data.supportEmail}</a> or visit our <a href="${data.homeUrl}/faq">FAQs section</a>.</p>
                            <p>
                                Thank you!
                            </p>
                            <p>
