                ...
                <tr>
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:14px;line-height:20px;color:#484848;font-family:Arial, Helvetica, sans-serif;">
                            <p>
                                I'm Tatiana, co-founder and CEO of ${data.brandName}. I personally wanted to welcome you and thank you for joining our platform.
                            </p>
                            <p>
                                I also noticed that you posted your first look. - Did you find the platform easy to use?
                            </p>
                            <p>
                                You can share your look feed page using your TinyURL from the dashboard on your social media bio to get people buying your looks.
                            </p>
                            <p>
                                I'd love to know a little bit more about you and to understand what are your needs or issues with growing your personal brand.
                            </p>
                            <p>
                                Looking forward to hearing from you soon and to spotting more looks on our platform.
                            <p>
                                Kind regards,
                            </p>
                            <p>
