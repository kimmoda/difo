                ...
                <tr>
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:14px;line-height:20px;color:#484848;font-family:Arial, Helvetica, sans-serif;">
                            <p>
                                Thank you for applying to become a trendsetter on ${data.brandName}!
                            </p>
                            <p>We have received your application and it is currently under review.
                            </p>
                            <p>
                                If you are approved, you will receive an email from us in approximately 48 hours.
                            </p>
                            <p>In the meantime, if you have any questions, please do not hesitate to reach out to our friendly support team at <a
                                    href="${data.supportEmail}" style="color: #484848"> ${data.supportEmail}</a></p>
                            <p>
                                Thank you!
                            </p>
                            <p>
