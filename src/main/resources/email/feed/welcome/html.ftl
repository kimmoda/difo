            ...
            <table border="0" cellpadding="0" cellspacing="0" width="80%" bgcolor="#FFFFFF"
                ...
                <tr>
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:18px;color:#222222;font-family:Arial, Helvetica, sans-serif;">
                            Dear ${data.brandName} Style Seeker,
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border-collapse:collapse;padding-left:40px;padding-right:40px;" colspan="2">
                        <div style="font-size:14px;line-height:20px;color:#484848;font-family:Arial, Helvetica, sans-serif;">
                            <p>
                                Welcome to our up and coming ${data.brandName} fashion community!
                            </p>
                            <p>
                                ${data.brandName} is an online community designed for those with a passion for fashion, and we are delighted to have you join our community!
                            </p>
                            <p>
                            ...
                            <ol>
                                <li>
                                    Browse looks, styles, and collections by Trendsetters for inspiration and ideas.
                                </li>
                                <li>
                                    Build a "Favorites" list with your favorite looks and styles.
                                </li>
                                <li>
                                    Add your own looks and tag brands featured in your looks.
                                </li>
                                <li>
                                    Like and comment on your favorite looks.
                                </li>
                                <li>
                                    Follow your favorite Trendsetters.
                                </li>
                                <li>
                                    Visit your dashboard anytime for notifications, likes, and comments.
                                </li>
                            </ol>
                            <p>
                                Excited to get started? <a href="${data.homeUrl}" target="_blank">Click here</a>
                            </p>
                            <p>
                                Are you a Fashion Trendsetter? <a href="${data.applyUrl}" target="_blank">Apply now</a>
                            </p>
                ...
                <tr>
                    <td style="text-align: center;" colspan="2">
                        <a href="${data.homeUrl}/inspiration">
                ...
                <tr style="border-top: 2px solid #7d7d7d">
                    ...
                    <td style="text-align: right; padding-right: 40px; font-size: 12px">
                        <div>
                            <a href="mailto:${data.supportEmail}" style="color: #7d7d7d">${data.supportEmail}</a>
                        </div>
                        <div>
