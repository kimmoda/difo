...
public interface CommonConfigRepository {
    ...
    List<CommonConfigEntity> createOrUpdate() throws HttpClientConnectionException, JsonParseException, JsonMappingException, IOException;

    CommonConfigEntity getEnabledConfigByKey(String key);
}
