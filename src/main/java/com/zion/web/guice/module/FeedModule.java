...
import com.zion.feed.FeedServiceImpl;
import com.zion.media.FileService;
import com.zion.media.FileServiceImpl;
import com.zion.mongo.db.repository.FeedRepository;
import com.zion.mongo.db.repository.FeedRepositoryImpl;
...
public class FeedModule extends AbstractModule {
	...
	protected void configure() {
		...
		bind(FeedRepository.class).to(FeedRepositoryImpl.class);
	}
}
