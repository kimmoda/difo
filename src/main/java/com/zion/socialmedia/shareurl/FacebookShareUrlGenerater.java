...
public class FacebookShareUrlGenerater extends AbstractShareUrlGenerater {
    
	@Override
	public String getShareUrl(String title, String description, String url, String image) {
		return String.format(getUrlFormat(), encode(url), encode(title), encode(description));
	}
	
	@Override
	public String getUrlFormat() {
		return "https://www.facebook.com/sharer/sharer.php?u=%s&title=%s&description=%s";
	}
